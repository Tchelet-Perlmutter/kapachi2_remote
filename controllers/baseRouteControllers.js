 ...
 * @param {*} res
 */
exports.postDoc = async function (
  newDocContent,
  theCollectionModel,
  isResEnd,
  res
    ...
    document = await new theCollectionModel(newDocContent)
      ...
      .then(async (doc) => {
        ...
        if ((theCollectionModel == Message) & (doc.isGiftMessage == true)) {
          ...
          fewRoutesControllers.addKeyToSender(doc);
 ...
 */
exports.youGotMessageSMS = async function (reqBody) {
  try {
 ...
 * @param {*} res
 */
exports.addKeyToSender = async function (newMessage, res) {
